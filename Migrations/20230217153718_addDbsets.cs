        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_LessonNames_NameId",
                        column: x => x.NameId,
                        principalTable: "LessonNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Lessons_LessonTags_TagId",
                        column: x => x.TagId,
                        principalTable: "LessonTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_NameId",
                table: "Lessons",
                column: "NameId");

            migrationBuilder.CreateIndex(
                name: "IX_Lessons_TagId",
                table: "Lessons",
                column: "TagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_TimeIntervalId",
                table: "Lessons",
